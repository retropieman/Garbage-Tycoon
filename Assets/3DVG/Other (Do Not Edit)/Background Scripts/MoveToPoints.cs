...
public class MoveToPoints : MonoBehaviour 
{
	...
	void Awake()
	{
		if(transform.tag != "Enemy")
		{
			...
			wayPoint1 = new GameObject("wp1");
			wayPoint1.transform.position = gameObject.transform.position;
			wayPoint1.tag = "Waypoint";
			wayPoint1.transform.parent = gameObject.transform;
		}
		else
		{
