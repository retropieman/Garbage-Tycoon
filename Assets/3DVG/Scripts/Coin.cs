...
public class Coin : MonoBehaviour 
{
	...
	Vector3 rotation = new Vector3(0, 80, 0);		//idle rotation of coin
	Vector3 rotationGain = new Vector3(10, 20, 10);	//added rotation when player gets near coin 
	float startSpeed = 3f;							//how fast coin moves toward player when they get near
	float speedGain = 0.2f;							//how fast coin accelerates toward player when they're near
